...
9. **Portal uploads (Ariba-like):** [07-portal-uploads-ariba.md](07-portal-uploads-ariba.md). SAP sources: [ariba-sources.md](flows/ariba-folder-upload/ariba-sources.md). Importable cloud flow: [AribaFolderUpload-package.zip](flows/ariba-folder-upload/cloud/AribaFolderUpload-package.zip). Desktop robin: [flows/ariba-folder-upload/](flows/ariba-folder-upload/README.md).
