...
9. **Portal uploads (Ariba-like):** [07-portal-uploads-ariba.md](07-portal-uploads-ariba.md) — drop PDFs in a folder, run the flow, HTML file input vs Windows Open dialog.
